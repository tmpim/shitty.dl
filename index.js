module.exports = (config) => {
	...
	let customName = config.customName || "./custom-name.js";
	if (fs.existsSync(customName)) {
		customName = require(customName);
	}
...
if (require.main === module) {
	console.warn("Hey! You are using an unmigrated version of shitty.dl! Please run using cli.js instead of index.js or migrate to the npm package.")
	console.warn("Continuing like nothing happened...");
